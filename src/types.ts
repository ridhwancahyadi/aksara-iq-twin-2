export type View = 'home' | 'student_twin' | 'lobby' | 'history' | 'playback' | 'curriculum' | 'dna' | 'fgd_assignment' | 'schedule' | 'courses' | 'settings' | 'comm_labs' | 'aksara_ai' | 'course_class_details' | 'competitions' | 'internships' | 'career_aspirations' | 'scholarships' | 'katalog_mitra' | 'kesiapan_saya' | 'detail_partners' | 'exchange_summary' | 'upskilling_explore' | 'skill_space' |  
